            ...
            <div class="container relative z-20 flex flex-col w-full px-5 pb-1 pr-12 mb-16 text-2xl text-gray-700 lg:w-1/2 sm:pr-0 md:pr-6 md:pl-0 lg:pl-5 xl:pr-10 sm:items-center lg:items-start lg:mb-0">
                ...
                <div class="relative flex mt-4">
                    ...
                    <a href="#_" class="relative flex items-center self-start justify-center py-2 pl-10 pr-5 mt-5 ml-5 text-base font-medium leading-tight text-red-500 transition duration-150 ease-in-out bg-gray-100 border-transparent rounded-full shadow-sm lg:py-4 md:pl-16 md:pr-5 xl:pr-10 hover:text-gray-400 focus:outline-none md:text-lg xl:text-xl" data-primary="purple-500" data-rounded="rounded-full">
                        ...
                        <span class="text-gray-500" data-primary="red-600">Youtube</span>
                    </a>
                </div>
            </div>
